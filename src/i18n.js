    ...
    resources: {
      en: {
        translation: {
          ...
          offlineYouAreOffline: "You're offline.",
          pendingChanges_one: "{{count}} pending change",
          pendingChanges_other: "{{count}} pending changes",
          pendingSync_one: "change pending sync",
          pendingSync_other: "changes pending sync",
          syncingOffline_one: "Syncing {{count}} offline change...",
          syncingOffline_other: "Syncing {{count}} offline changes...",
          offlineSyncSuccess: "All changes synced",
          offlineSyncPartial: "{{succeeded}} synced, {{failed}} failed — will retry later",
          ...
          // Budgets page
          budgets: "Budgets",
          budgetsSubtitle: "Plan monthly spending by category",
          ...
          budgetLimitRequired: "Enter an amount greater than 0",
          budgetCategoryRequired: "Select a category",
          budgetSpent: "of",
          budgetSpentLabel: "spent",
          budgetOverLimit: "over limit",
          budgetCount_one: "{{count}} budget",
          budgetCount_other: "{{count}} budgets",
          budgetRemaining: "{{amount}} left",
          budgetAlmostOver: "Almost at limit",
          budgetOverBy: "Over by {{amount}}",
          budgetsNoData: "No budgets yet",
          budgetsNoDataHint: "Set a monthly limit to start planning your spending",
          ...
          ratesUnavailableHint: "Exchange rates unavailable — amounts shown without conversion.",
          ...
          settingsClearDataConfirmWord: "CLEAR",
      ...
      ru: {
        translation: {
          ...
          offlineYouAreOffline: "Вы офлайн.",
          pendingChanges_one: "{{count}} изменение ожидает",
          pendingChanges_few: "{{count}} изменения ожидают",
          pendingChanges_many: "{{count}} изменений ожидают",
          pendingChanges_other: "{{count}} изменений ожидают",
          pendingSync_one: "изменение ожидает синхронизации",
          pendingSync_few: "изменения ожидают синхронизации",
          pendingSync_many: "изменений ожидают синхронизации",
          pendingSync_other: "изменений ожидают синхронизации",
          syncingOffline_one: "Синхронизация {{count}} изменения...",
          syncingOffline_few: "Синхронизация {{count}} изменений...",
          syncingOffline_many: "Синхронизация {{count}} изменений...",
          syncingOffline_other: "Синхронизация {{count}} изменений...",
          offlineSyncSuccess: "Все изменения синхронизированы",
          offlineSyncPartial: "{{succeeded}} синхронизировано, {{failed}} не удалось — попробуем позже",
          savedOffline: "Сохранено офлайн. Синхронизируется при подключении.",
          ...
          // Страница бюджетов
          budgets: "Бюджеты",
          budgetsSubtitle: "Планируйте месячные траты по категориям",
          addBudget: "Добавить бюджет",
          addFirstBudget: "Добавьте первый бюджет",
          editBudget: "Редактировать бюджет",
          deleteBudget: "Удалить бюджет",
          deleteBudgetConfirm: "Удалить этот бюджет?",
          budgetLimit: "Лимит на месяц",
          budgetCategory: "Категория",
          budgetLimitRequired: "Введите сумму больше 0",
          budgetCategoryRequired: "Выберите категорию",
          budgetSpent: "из",
          budgetSpentLabel: "потрачено",
          budgetOverLimit: "сверх лимита",
          budgetCount_one: "{{count}} бюджет",
          budgetCount_few: "{{count}} бюджета",
          budgetCount_many: "{{count}} бюджетов",
          budgetCount_other: "{{count}} бюджетов",
          budgetRemaining: "Осталось {{amount}}",
          budgetAlmostOver: "почти у лимита",
          budgetOverBy: "Превышен на {{amount}}",
          budgetsNoData: "Пока нет бюджетов",
          budgetsNoDataHint: "Установите месячный лимит, чтобы планировать траты",
          ...
          ratesUnavailableHint: "Курсы валют недоступны — суммы показаны без конвертации.",
          ...
          settingsClearDataConfirmWord: "ОЧИСТИТЬ",
